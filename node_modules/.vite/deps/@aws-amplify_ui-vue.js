...
// node_modules/@aws-amplify/ui-vue/dist/index.js
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return renderSlot(_ctx.$slots, "fieldSetI", mergeProps(_ctx.$attrs, {
        ...
        createBaseVNode("fieldset", mergeProps(_ctx.$attrs, { "data-amplify-fieldset": "" }), [
...
var _hoisted_1$b = ["type", "data-fullwidth", "data-size", "data-fontWeight", "data-variation", "data-loading", "data-disabled", "disabled"];
...
var e$f = ["birthdate", "email", "family_name", "given_name", "middle_name", "name", "nickname", "phone_number", "preferred_username", "profile", "website"];
var a$4 = ["username", "email", "phone_number"];
var r$5 = [...a$4, ...e$f, "confirmation_code", "password", "confirm_password"];
var i$5 = (e2) => r$5.includes(e2);
var e$e;
!function(e2) {
...
var n$5 = (r2) => {
  var n2, s2, i2, a2, o2;
  const c2 = null !== (n2 = o$a(r2)) && void 0 !== n2 ? n2 : {}, { codeDeliveryDetails: u2, remoteError: d2, unverifiedContactMethods: l2, validationError: m2, totpSecretCode: h22 = null } = c2, { socialProviders: v2 } = null !== (i2 = null === (s2 = r2.context) || void 0 === s2 ? void 0 : s2.config) && void 0 !== i2 ? i2 : {}, g2 = null !== (a2 = null == c2 ? void 0 : c2.user) && void 0 !== a2 ? a2 : null === (o2 = r2.context) || void 0 === o2 ? void 0 : o2.user, f2 = m2 && Object.keys(m2).length > 0, p2 = t$1(r2), S = r2.hasTag("pending") || (null == p2 ? void 0 : p2.hasTag("pending")), I = (() => {
    switch (true) {
...
var s$2 = ({ packageName: t2, version: e2 }) => {
  appendToCognitoUserAgent(`${t2}/${e2}`);
};
var l$1 = (e2) => __awaiter(void 0, void 0, void 0, function* () {
  try {
    yield waitFor_2(e2, (t2) => t$1(t2).matches("autoSignIn"));
  } catch (t2) {
  }
});
var d$1 = (e2, a2) => __awaiter(void 0, void 0, void 0, function* () {
...
var u$1 = (t2, a2 = d$1) => Hub.listen("auth", ((t3, e2) => (a3) => {
  e2(a3, t3);
})(t2, a2), "authenticator-hub-handler");
var h$1 = (t2) => a$2.some((e2) => t2.includes(e2));
var m$2 = (t2, e2, a2) => encodeURI(`otpauth://totp/${t2}:${e2}?secret=${a2}&issuer=${t2}`);
function p$2(t2, ...e2) {
...
var c$2 = (o2) => ({ confirmation_code: Object.assign(Object.assign({}, n$3(o2, "confirmation_code")), { label: "Code *", placeholder: "Code" }) });
var i$3 = { signIn: (o2) => ({ username: Object.assign({}, a$1(o2)), password: Object.assign(Object.assign({}, n$3(o2, "password")), { autocomplete: "current-password" }) }), signUp: (o2) => {
...
var r$2 = (r2) => {
  ...
  for (const [t2, s2] of Object.entries(r2)) {
    ...
    o2[t2] = Object.assign(Object.assign({}, s2), { label: r3 ? b$2(r3) : void 0, placeholder: n2 ? b$2(n2) : void 0 });
  }
  return o2;
};
var o$3 = (e2) => Object.entries(e2).sort((e3, r2) => (e3[1].order || Number.MAX_VALUE) - (r2[1].order || Number.MAX_VALUE)).filter((e3) => void 0 !== e3[1]);
var a = (s2, t2) => (0, i$3[s2])(t2);
var c$1 = (r2, i2) => {
  var o2, a2;
...
var j$2 = (s2) => s2.map((s3) => [s3[0], Object.assign(Object.assign({}, s3[1]), { order: void 0 })]);
var b$1 = (s2, t2) => {
  const e2 = m$1(s2, t2);
  return j$2(o$3(e2));
};
var T = { amazon: "Amazon", apple: "Apple", facebook: "Facebook", google: "Google" };
var n$2 = { getBackToSignInText: () => b$2(x.BACK_SIGN_IN), getChangePasswordText: () => b$2(x.CHANGE_PASSWORD), getChangingText: () => b$2(x.CHANGING_PASSWORD), getConfirmText: () => b$2(x.CONFIRM), getConfirmingText: () => b$2(x.CONFIRMING), getCopyText: () => b$2(x.UPPERCASE_COPY), getHidePasswordText: () => b$2(x.HIDE_PASSWORD), getLoadingText: () => b$2(x.LOADING), getOrText: () => b$2(x.OR), getResendCodeText: () => b$2(x.RESEND_CODE), getSendCodeText: () => b$2(x.SEND_CODE), getSendingText: () => b$2(x.SENDING), getShowPasswordText: () => b$2(x.SHOW_PASSWORD), getSubmitText: () => b$2(x.SUBMIT), getSubmittingText: () => b$2(x.SUBMITTING), getSignInTabText: () => b$2(x.SIGN_IN_TAB), getSignUpTabText: () => b$2(x.CREATE_ACCOUNT), getForgotPasswordText: (T2) => b$2(T2 ? x.FORGOT_PASSWORD : x.FORGOT_YOUR_PASSWORD), getSigningInText: () => b$2(x.SIGNING_IN_BUTTON), getSignInText: () => b$2(x.SIGN_IN_BUTTON), getCreatingAccountText: () => b$2(x.CREATING_ACCOUNT), getCreateAccountText: () => b$2(x.CREATE_ACCOUNT), getDeliveryMessageText: (T2) => {
  const { DeliveryMedium: n2, Destination: g2 } = null != T2 ? T2 : {}, S = "EMAIL" === n2, o2 = "SMS" === n2, i2 = b$2(x.CODE_ARRIVAL);
  if (!S && !o2)
    return `${b$2(x.CODE_SENT)}. ${i2}.`;
  return `${b$2(S ? x.CODE_EMAILED : x.CODE_TEXTED)} ${g2}. ${i2}.`;
}, getDeliveryMethodText: (T2) => {
  const { DeliveryMedium: n2 } = null != T2 ? T2 : {}, g2 = "EMAIL" === n2;
  return b$2(g2 || "SMS" !== n2 ? g2 ? x.WE_EMAILED : x.WE_TEXTED : x.WE_SENT_CODE);
}, getChallengeText: (T2) => {
  switch (T2) {
    case "SMS_MFA":
      return b$2(x.CONFIRM_SMS);
    case "SOFTWARE_TOKEN_MFA":
      return b$2(x.CONFIRM_TOTP);
    default:
      throw new Error(`${b$2("Unexpected challengeName encountered in ConfirmSignIn:")} ${T2}`);
  }
}, getResetYourPasswordText: () => b$2(x.RESET_PASSWORD), getSetupTOTPText: () => b$2(x.SETUP_TOTP), getSetupTOTPInstructionsText: () => b$2("Copy and paste the secret key below into an authenticator app and then enter the code in the text field below."), getCopiedText: () => b$2("COPIED"), getSignInWithFederationText: (t2, n2) => b$2(`Sign ${"signIn" === t2 ? "In" : "Up"} with ${T[n2]}`), getSkipText: () => b$2(x.SKIP), getVerifyText: () => b$2(x.VERIFY), getVerifyContactText: () => b$2(x.VERIFY_CONTACT), getAccountRecoveryInfoText: () => b$2(x.VERIFY_HEADING) };
...
var actionTypes = Object.freeze(Object.defineProperty({
  __proto__: null,
  after: after$1,
  assign: assign$2,
  cancel: cancel$1,
...
var toActionObjects = function(action, actionFunctionMap) {
  ...
  var actions = isArray$a(action) ? action : [action];
...
function stop(actorRef) {
  var activity = isFunction$4(actorRef) ? actorRef : toActivityDefinition(actorRef);
  return {
...
function resolveStop(action, context, _event) {
  var actorRefOrString = isFunction$4(action.activity) ? action.activity(context, _event.data) : action.activity;
...
var r$1 = Object.freeze(Object.defineProperty({
  __proto__: null,
  actionTypes,
  after,
  assign: assign$1,
...
function getValue$2(rootNode, configuration) {
      ...
      switch (action.type) {
        ...
        case start$1: {
          ...
          if (activity.type === ActionTypes.Invoke) {
            ...
            var source = isFunction$4(serviceCreator) ? serviceCreator(context, _event.data, {
              data: resolvedData,
              src: invokeSource,
              meta: activity.meta
            }) : serviceCreator;
...
var StateNode = function() {
  ...
  Object.defineProperty(StateNode2.prototype, "context", {
    get: function() {
      return isFunction$4(this._context) ? this._context() : this._context;
    },
    enumerable: false,
    configurable: true
  });
  ...
  StateNode2.prototype.getDelayedTransitions = function() {
    ...
    var mutateEntryExit = function(delay, i2) {
      var delayRef = isFunction$4(delay) ? "".concat(_this.id, ":delay[").concat(i2, "]") : delay;
...
var assign = assign$1;
var sendUpdate = sendUpdate$1;
var forwardTo = forwardTo$1;
var { assign: o$2, stop: s$1 } = r$1;
var n$1 = (e2) => s$1(e2);
var i$2 = o$2({ attributeToVerify: (e2) => {
} });
var u = o$2({ challengeName: (e2) => {
} });
var m = o$2({ requiredAttributes: (e2) => {
} });
var l = o$2({ remoteError: (e2) => "" });
var d = o$2({ formValues: (e2) => ({}) });
var c = o$2({ touched: (e2) => ({}) });
var p$1 = o$2({ unverifiedContactMethods: (e2) => {
} });
var f$1 = o$2({ username: (e2) => {
} });
var v$1 = o$2({ validationError: (e2) => ({}) });
var h2 = o$2({ totpSecretCode: (e2, r2) => r2.data });
var g$1 = o$2({ challengeName: (e2, r2) => {
  var t2;
  return null === (t2 = r2.data) || void 0 === t2 ? void 0 : t2.challengeName;
} });
var b = o$2({ requiredAttributes: (e2, r2) => {
  var t2, a2;
  return null === (a2 = null === (t2 = r2.data) || void 0 === t2 ? void 0 : t2.challengeParam) || void 0 === a2 ? void 0 : a2.requiredAttributes;
} });
var V = o$2({ redirectIntent: (e2) => "confirmPasswordReset" });
var j$1 = o$2({ redirectIntent: (e2) => "confirmSignUp" });
var y$1 = o$2({ authAttributes: (e2, r2) => {
  var t2, a2;
...
var O$1 = o$2({ validationError: (e2, r2) => r2.data });
var _$1 = o$2({ remoteError: (e2, r2) => {
  var t2;
...
var w = o$2({ unverifiedContactMethods: (e2, r2) => r2.data.unverified });
var A = o$2({ user: (e2, r2) => r2.data.user || r2.data });
var C = o$2({ username: (e2, r2) => {
  let { formValues: { username: t2, country_code: a2 } } = e2;
  return a2 && (t2 = `${a2}${t2}`), t2;
} });
var E = o$2({ codeDeliveryDetails: (e2, r2) => r2.data.codeDeliveryDetails });
var N = o$2({ authAttributes: (e2, r2) => ({ username: e2.formValues.username }) });
var $ = o$2({ formValues: (e2, r2) => {
  const { name: t2, value: a2 } = r2.data;
  return Object.assign(Object.assign({}, e2.formValues), { [t2]: a2 });
} });
var D = o$2({ formValues: (e2, r2) => {
  const t2 = Object.assign(Object.assign({}, e2.formValues), r2.data);
  return p$2(t2, "password");
} });
var M = o$2({ touched: (e2, r2) => {
  const { name: t2 } = r2.data;
  return Object.assign(Object.assign({}, e2.touched), { [`${t2}`]: true });
} });
var P = (t2) => __awaiter(void 0, void 0, void 0, function* () {
  const { username: e2 } = t2;
  return yield Auth.forgotPassword(e2);
});
var q = o$2({ formValues: (e2, r2) => {
  var t2;
...
function arrayLikeKeys$2(value, inherited) {
  var isArr = isArray$5(value), isArg = !isArr && isArguments$2(value), isBuff = !isArr && !isArg && isBuffer$2(value), isType = !isArr && !isArg && !isBuff && isTypedArray$2(value), skipIndexes = isArr || isArg || isBuff || isType, result = skipIndexes ? baseTimes(value.length, String) : [], length = result.length;
...
var i = createMachine({ initial: "pending", id: "signOutActor", predictableActionArguments: true, states: { pending: { tags: ["pending"], invoke: { src: "signOut", onDone: "resolved", onError: "rejected" } }, resolved: { type: "final" }, rejected: { type: "final" } } }, { services: { signOut: () => Auth.signOut() } });
...
function v() {
  return createMachine({ id: "authenticator", initial: "idle", context: { user: void 0, config: {}, services: o, actorRef: void 0, hasSetup: false }, predictableActionArguments: true, states: { idle: { invoke: { src: "getCurrentUser", onDone: { actions: "setUser", target: "authenticated" }, onError: { target: "setup" } } }, setup: { initial: "waitConfig", states: { waitConfig: { on: { INIT: { actions: ["configure", "setHasSetup"], target: "applyConfig" } } }, applyConfig: { invoke: { src: "getAmplifyConfig", onDone: { actions: "applyAmplifyConfig", target: "goToInitialState" } } }, goToInitialState: { always: [{ target: "#authenticator.signUp", cond: "isInitialStateSignUp" }, { target: "#authenticator.resetPassword", cond: "isInitialStateResetPassword" }, { target: "#authenticator.signIn" }] } } }, signIn: { initial: "spawnActor", states: { spawnActor: { always: { actions: "spawnSignInActor", target: "runActor" } }, runActor: { entry: "clearActorDoneData", exit: "stopSignInActor" } }, on: { SIGN_UP: "signUp", RESET_PASSWORD: "resetPassword", "done.invoke.signInActor": [{ target: "signUp", actions: "setActorDoneData", cond: "shouldRedirectToSignUp" }, { target: "resetPassword", actions: "setActorDoneData", cond: "shouldRedirectToResetPassword" }, { target: "authenticated", actions: "setActorDoneData" }] } }, signUp: { initial: "spawnActor", states: { spawnActor: { always: { actions: "spawnSignUpActor", target: "runActor" } }, runActor: { entry: "clearActorDoneData", exit: "stopSignUpActor" }, autoSignIn: { invoke: { src: "getCurrentUser", onDone: "#authenticator.authenticated", onError: "#authenticator.setup.goToInitialState" } } }, on: { SIGN_IN: "signIn", "done.invoke.signUpActor": { target: "#authenticator.signIn", actions: "setActorDoneData", cond: "shouldAutoSignIn" } } }, resetPassword: { initial: "spawnActor", states: { spawnActor: { always: { actions: "spawnResetPasswordActor", target: "runActor" } }, runActor: { entry: "clearActorDoneData", exit: "stopResetPasswordActor" } }, on: { SIGN_IN: "signIn", "done.invoke.resetPasswordActor": { target: "signIn", actions: "setActorDoneData" } } }, signOut: { initial: "spawnActor", states: { spawnActor: { always: { actions: "spawnSignOutActor", target: "runActor" } }, runActor: { entry: "clearActorDoneData", exit: ["stopSignOutActor", "clearUser"] } }, on: { "done.invoke.signOutActor": [{ target: "setup", cond: "shouldSetup" }, { target: "setup.goToInitialState" }] } }, authenticated: { initial: "idle", states: { idle: { on: { TOKEN_REFRESH: "refreshUser" } }, refreshUser: { invoke: { src: "getCurrentUser", onDone: { actions: "setUser", target: "idle" }, onError: { target: "#authenticator.signOut" } } } }, on: { SIGN_OUT: "signOut" } } }, on: { CHANGE: { actions: "forwardToActor" }, BLUR: { actions: "forwardToActor" }, SUBMIT: { actions: "forwardToActor" }, FEDERATED_SIGN_IN: { actions: "forwardToActor" }, AUTO_SIGN_IN: { actions: "forwardToActor" }, RESEND: { actions: "forwardToActor" }, SIGN_IN: { actions: "forwardToActor" }, SKIP: { actions: "forwardToActor" } } }, { actions: { forwardToActor: g([{ cond: "hasActor", actions: forwardTo((t2) => t2.actorRef) }]), setUser: assign({ user: (t2, o2) => o2.data }), setActorDoneData: assign({ actorDoneData: (t2, o2) => {
    ...
    const { loginMechanisms: w2, signUpAttributes: S, socialProviders: m2, initialState: h22, formFields: D2 } = t2.config;
    return { loginMechanisms: null != w2 ? w2 : l2, formFields: null !== (u2 = p(D2)) && void 0 !== u2 ? u2 : {}, passwordSettings: f2, signUpAttributes: null != S ? S : Array.from(/* @__PURE__ */ new Set([...g2, ...v2])), socialProviders: null != m2 ? m2 : A2.sort(), initialState: h22 };
...
var _hoisted_2$6 = { class: "amplify-flex amplify-authenticator__icon-wrapper" };
var _hoisted_3$5 = createBaseVNode("svg", {
...
var _hoisted_4$5 = createBaseVNode("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  class: "amplify-icon",
  "aria-hidden": "true",
  viewBox: "0 0 24 24",
...
var _sfc_main$w = {
  ...
  setup(__props) {
    const show = ref(true);
    const dismissAriaLabel = b$2("Dismiss alert");
    function close() {
      show.value = false;
    }
    return (_ctx, _cache) => {
...
var __unplugin_components_2 = _export_sfc(_sfc_main$v, [["render", _sfc_render$3]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return renderSlot(_ctx.$slots, "formt", mergeProps(_ctx.$attrs, {
        ...
        createBaseVNode("form", mergeProps({ "data-amplify-form": "" }, _ctx.$attrs), [
          renderSlot(_ctx.$slots, "default")
        ], 16)
      ]);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return renderSlot(_ctx.$slots, "footert", mergeProps(_ctx.$attrs, {
        ...
        createBaseVNode("footer", normalizeProps(guardReactiveProps(_ctx.$attrs)), [
          renderSlot(_ctx.$slots, "default")
        ], 16)
      ]);
    };
...
var service = ref();
var useAuthenticatorValue = reactive({
  ...facade,
  send: "",
  state: ""
});
...
var useAuthenticator = useInternalAuthenticator;
...
var _hoisted_1$9 = createBaseVNode("svg", {
...
var _hoisted_2$5 = { class: "amplify-text amplify-authenticator__federated-text" };
var _hoisted_3$4 = createBaseVNode("svg", {
...
var _hoisted_4$4 = { class: "amplify-text amplify-authenticator__federated-text" };
var _hoisted_5$2 = createBaseVNode("svg", {
...
var _hoisted_6$2 = { class: "amplify-text amplify-authenticator__federated-text" };
var _hoisted_7$1 = createBaseVNode("svg", {
...
var _hoisted_8$1 = { class: "amplify-text amplify-authenticator__federated-text" };
var _hoisted_9$1 = ["data-label"];
      ...
      return unref(shouldShowFederatedSignIn) ? (openBlock(), createBlock(_component_base_wrapper, {
        ...
        default: withCtx(() => [
          unref(includeAmazon) ? (openBlock(), createBlock(_sfc_main$s, {
            ...
            default: withCtx(() => [
              _hoisted_1$9,
              createBaseVNode("p", _hoisted_2$5, toDisplayString(unref(signInWithAmazon)), 1)
            ]),
            _: 1
          ...
          unref(includeApple) ? (openBlock(), createBlock(_sfc_main$s, {
            ...
            default: withCtx(() => [
              _hoisted_3$4,
              createBaseVNode("p", _hoisted_4$4, toDisplayString(unref(signInWithApple)), 1)
            ]),
            _: 1
          }, 8, ["provider"])) : createCommentVNode("", true),
          unref(includeFacebook) ? (openBlock(), createBlock(_sfc_main$s, {
            ...
            default: withCtx(() => [
              _hoisted_5$2,
              createBaseVNode("p", _hoisted_6$2, toDisplayString(unref(signInWithFacebook)), 1)
            ]),
            _: 1
          }, 8, ["provider"])) : createCommentVNode("", true),
          unref(includeGoogle) ? (openBlock(), createBlock(_sfc_main$s, {
            ...
            default: withCtx(() => [
              _hoisted_7$1,
              createBaseVNode("p", _hoisted_8$1, toDisplayString(unref(signInWithGoogle)), 1)
            ]),
            _: 1
          }, 8, ["provider"])) : createCommentVNode("", true),
          createBaseVNode("hr", {
...
var _sfc_main$q = {};
var _hoisted_1$8 = { "data-amplify-label": "" };
function _sfc_render$2(_ctx, _cache) {
  return openBlock(), createElementBlock("label", _hoisted_1$8, [
    renderSlot(_ctx.$slots, "default")
  ]);
}
var __unplugin_components_0 = _export_sfc(_sfc_main$q, [["render", _sfc_render$2]]);
...
var _hoisted_1$7 = ["aria-label", "aria-checked"];
var _hoisted_2$4 = createBaseVNode("path", { d: "M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" }, null, -1);
var _hoisted_3$3 = [
  _hoisted_2$4
];
var _hoisted_4$3 = createBaseVNode("path", {
...
var _sfc_main$o = defineComponent({
  ...
  setup(__props) {
    var _a2;
    const props = __props;
    const showPassword = b$2("Show password");
    const hidePassword = b$2("Hide password");
    ...
    const placeholderValue = b$2((_a2 = placeholder == null ? void 0 : placeholder.value) != null ? _a2 : label.value);
    const labelValue = b$2(label.value);
    return (_ctx, _cache) => {
              ...
              createVNode(_component_base_wrapper, {
                ...
                default: withCtx(() => [
                  createBaseVNode("button", {
                    ...
                    showHideType.value === "password" ? (openBlock(), createElementBlock("svg", {
                      key: 0,
                      xmlns: "http://www.w3.org/2000/svg",
                      fill: "currentColor",
                      viewBox: "0 0 24 24",
...
var _hoisted_1$6 = ["value", "selected"];
...
var _hoisted_1$5 = createBaseVNode("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  "data-size": "large",
  fill: "currentColor",
  viewBox: "0 0 24 24",
      ...
      return openBlock(), createBlock(_component_base_wrapper, { class: "amplify-flex amplify-field amplify-textfield amplify-phonenumberfield amplify-authenticator__column" }, {
        default: withCtx(() => [
          createVNode(_component_base_label, mergeProps({
            for: "amplify-field-" + unref(random),
            class: ["amplify-label", { "amplify-visually-hidden": unref(labelHidden) }]
          }, _ctx.$attrs), {
            default: withCtx(() => [
                      ...
                      createVNode(_component_base_wrapper, { class: "amplify-select__wrapper" }, {
                        default: withCtx(() => [
                          createVNode(_component_base_select, {
                            ...
                            id: "amplify-field-" + unref(randomPhone),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        isPasswordField ? (openBlock(), createBlock(_sfc_main$o, {
          ...
          placeholder: unref(formField).placeholder,
        ...
        unref(hasError) ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(errors), (error2, idx) => {
            ...
            }, toDisplayString(unref(b$2)(error2)), 1);
          }), 128))
    ...
    return (_ctx, _cache) => {
      return openBlock(true), createElementBlock(Fragment, null, renderList(unref(formFields), ([name, formField]) => {
        return openBlock(), createBlock(_sfc_main$l, {
          ...
          key: name,
          formField
        }, null, 8, ["name", "formField"]);
      }), 128);
    };
  }
});
var _hoisted_1$3 = createBaseVNode("legend", { class: "amplify-visually-hidden" }, "Sign in", -1);
var _hoisted_2$3 = { "data-amplify-footer": "" };
    ...
    return (_ctx, _cache) => {
      ...
      return renderSlot(_ctx.$slots, "signInSlotI", normalizeProps(guardReactiveProps(_ctx.$attrs)), () => [
        ...
        createVNode(_component_base_wrapper, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              "data-amplify-authenticator-signin": "",
              onInput,
              onSubmit: withModifiers(onSignInSubmit, ["prevent"]),
              method: "post"
            }, {
              formt: withCtx(({ slotData }) => [
                ...
                createVNode(_component_base_wrapper, { class: "amplify-flex amplify-authenticator__column" }, {
                  default: withCtx(() => [
                    ...
                    unref(actorState).context.remoteError ? (openBlock(), createBlock(_component_base_alert, { key: 0 }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(b$2)(unref(actorState).context.remoteError)), 1)
                      ]),
                      _: 1
                    })) : createCommentVNode("", true),
                    createVNode(_component_amplify_button, {
            ...
            renderSlot(_ctx.$slots, "footer", {}, () => [
              createBaseVNode("div", _hoisted_2$3, [
                createVNode(_component_amplify_button, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(unref(forgotYourPasswordLink)), 1)
                  ]),
                  _: 1
                })
              ])
                ...
                createVNode(_component_base_wrapper, { class: "amplify-flex amplify-authenticator__column" }, {
                  default: withCtx(() => [
                    ...
                    unref(error2) ? (openBlock(), createBlock(_component_base_alert, { key: 0 }, {
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(b$2)(unref(error2))), 1)
                      ]),
                      _: 1
                    })) : createCommentVNode("", true),
                    createVNode(_component_amplify_button, {
                      ...
                      default: withCtx(() => [
                        createTextVNode(toDisplayString(unref(createAccountLabel)), 1)
                      ]),
                      _: 1
                    }, 8, ["disabled"])
                  ]),
...
var _sfc_main$g = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      const _component_base_wrapper = __unplugin_components_2;
      return openBlock(), createBlock(_component_base_wrapper, {
        tabindex: unref(active) ? 0 : -1,
        "data-state": unref(active) ? "active" : "inactive",
        "aria-selected": unref(active) ? "true" : "false",
        "aria-controls": `radix-id-${unref(id)}-8-content-0`,
        id: `radix-id-${unref(id)}-8-trigger-0`,
        ...
        _: 1
      }, 8, ["tabindex", "data-state", "aria-selected", "aria-controls", "id"]);
    };
  }
});
var _sfc_main$f = {};
...
var __unplugin_components_1 = _export_sfc(_sfc_main$f, [["render", _sfc_render$1]]);
var _sfc_main$e = defineComponent({
  ...
  setup(props, { slots, attrs }) {
    ...
    if (((_b = (_a2 = headingI[0]) == null ? void 0 : _a2.children) == null ? void 0 : _b.length) === 0) {
      ...
      return () => h(`h${props.level}`, { "data-amplify-heading": "", ...attrs, class: headerClass }, [
...
function _sfc_render(_ctx, _cache) {
  return renderSlot(_ctx.$slots, "textI", normalizeProps(guardReactiveProps(_ctx.$attrs)), () => [
    createBaseVNode("span", mergeProps(_ctx.$attrs, { "data-amplify-text": "" }), [
      renderSlot(_ctx.$slots, "default")
    ], 16)
  ]);
}
var __unplugin_components_3 = _export_sfc(_sfc_main$d, [["render", _sfc_render]]);
                  ...
                  default: withCtx(() => [
                    renderSlot(_ctx.$slots, "header", {}, () => [
                      createVNode(_component_base_heading, {
                        ...
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(unref(confirmSignUpHeading)), 1)
                        ]),
                        _: 1
                      })
                    ]),
        ...
        createVNode(_component_base_wrapper, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              ...
              onInput,
              onSubmit: withModifiers(onConfirmSignInSubmit, ["prevent"])
            }, {
              default: withCtx(() => [
                createVNode(_component_base_field_set, {
                  class: "amplify-flex amplify-authenticator__column",
                        ...
                        return [
                          ((_b = (_a2 = unref(actorState)) == null ? void 0 : _a2.context) == null ? void 0 : _b.remoteError) ? (openBlock(), createBlock(_component_base_alert, { key: 0 }, {
                            default: withCtx(() => {
                              var _a3, _b2;
                              return [
                                createTextVNode(toDisplayString(unref(b$2)((_b2 = (_a3 = unref(actorState)) == null ? void 0 : _a3.context) == null ? void 0 : _b2.remoteError)), 1)
                              ];
                            }),
                            _: 1
                          })) : createCommentVNode("", true),
...
(function(exports) {
  ...
  exports.fromString = function fromString(data, version2) {
    ...
    const path2 = dijkstra$1.find_path(graph.map, "start", "end");
    const optimizedSegs = [];
...
var _hoisted_3$2 = { "data-amplify-copy-tooltip": "" };
var _hoisted_4$2 = createBaseVNode("svg", {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  xmlns: "http://www.w3.org/2000/svg"
        ...
        createVNode(_component_base_wrapper, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              ...
              onInput,
              onSubmit: withModifiers(onSetupTOTPSubmit, ["prevent"])
            }, {
              default: withCtx(() => [
                createVNode(_component_base_field_set, {
                  class: "amplify-flex amplify-authenticator__column",
                  ...
                  default: withCtx(() => [
                    createVNode(_component_base_wrapper, { class: "amplify-flex amplify-authenticator__column" }, {
                      default: withCtx(() => [
                        ...
                        createVNode(_component_base_wrapper, { class: "amplify-flex amplify-authenticator__column" }, {
                          default: withCtx(() => [
                            qrCode.isLoading ? (openBlock(), createElementBlock("p", _hoisted_1$2, "Loading...")) : (openBlock(), createElementBlock("img", {
                              key: 1,
                              class: "amplify-image",
                              "data-amplify-qrcode": "",
                            ...
                            createVNode(_component_base_wrapper, {
                              ...
                              default: withCtx(() => [
                                createBaseVNode("div", null, toDisplayString(unref(totpSecretCode)), 1),
                                createVNode(_component_base_wrapper, {
                                  "data-amplify-copy-svg": "",
                                  onClick: copyText
                                }, {
                                  default: withCtx(() => [
                                    createBaseVNode("div", _hoisted_3$2, toDisplayString(copyTextLabel.value), 1),
                                    _hoisted_4$2
                                  ]),
                                  _: 1
                                })
        ...
        createVNode(_component_base_wrapper, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              ...
              onInput,
              onBlurCapture: onBlur,
              onSubmit: withModifiers(onForceNewPasswordSubmit, ["prevent"])
            }, {
              default: withCtx(() => [
                createVNode(_component_base_field_set, {
                  class: "amplify-flex amplify-authenticator__column",
                  ...
                  default: withCtx(() => [
                    renderSlot(_ctx.$slots, "header", {}, () => [
                      createVNode(_component_base_heading, {
                        ...
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(unref(changePasswordLabel)), 1)
                        ]),
                        _: 1
                      })
                    ]),
              ...
              default: withCtx(() => [
                renderSlot(_ctx.$slots, "header", {}, () => [
                  createVNode(_component_base_heading, {
                    ...
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(unref(resetPasswordHeading)), 1)
                    ]),
                    _: 1
                  })
                ]),
        ...
        createVNode(_component_base_wrapper, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              ...
              onInput,
              onBlurCapture: onBlur,
              onSubmit: withModifiers(onConfirmResetPasswordSubmit, ["prevent"])
            }, {
              default: withCtx(() => [
                createVNode(_component_base_field_set, {
                  class: "amplify-flex amplify-authenticator__column",
                  ...
                  default: withCtx(() => [
                    renderSlot(_ctx.$slots, "header", {}, () => [
                      createVNode(_component_base_heading, {
                        ...
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(unref(confirmResetPasswordHeading)), 1)
                        ]),
                        _: 1
                      })
                    ]),
      ...
      return renderSlot(_ctx.$slots, "verifyUserSlotI", {}, () => [
        createVNode(_component_base_wrapper, null, {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              onInput,
              onSubmit: withModifiers(onVerifyUserSubmit, ["prevent"])
            }, {
              default: withCtx(() => [
                createVNode(_component_base_field_set, {
                  ...
                  default: withCtx(() => [
                    renderSlot(_ctx.$slots, "header", {}, () => [
                      createVNode(_component_base_heading, {
                        ...
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(unref(verifyHeading)), 1)
                        ]),
                        _: 1
                      })
                    ]),
                    createVNode(_component_base_wrapper, { class: "amplify-flex amplify-field amplify-radiogroupfield amplify-authenticator__column" }, {
                      default: withCtx(() => [
                        createVNode(_component_base_label, {
                          ...
                          default: withCtx(() => [
                            createTextVNode(toDisplayString(unref(verifyContactText)), 1)
                          ]),
                          _: 1
                        }),
                        createVNode(_component_base_wrapper, {
                        ...
                        return [
                          ((_b = (_a2 = unref(actorState)) == null ? void 0 : _a2.context) == null ? void 0 : _b.remoteError) ? (openBlock(), createBlock(_component_base_alert, { key: 0 }, {
                            default: withCtx(() => {
                              var _a3;
                              return [
                                createTextVNode(toDisplayString(unref(b$2)((_a3 = unref(actorState)) == null ? void 0 : _a3.context.remoteError)), 1)
                              ];
                            }),
                            _: 1
                          })) : createCommentVNode("", true),
      ...
      return renderSlot(_ctx.$slots, "confirmVerifyUserSlotI", normalizeProps(guardReactiveProps(_ctx.$attrs)), () => [
        createVNode(_component_base_wrapper, normalizeProps(guardReactiveProps(_ctx.$attrs)), {
          default: withCtx(() => [
            createVNode(_component_base_form, {
              onInput,
              onSubmit: withModifiers(onConfirmVerifyUserSubmit, ["prevent"])
            }, {
              default: withCtx(() => [
                createVNode(_component_base_field_set, {
                  class: "amplify-flex amplify-authenticator__column",
...
var VERSION = "3.1.12";
var _hoisted_1$1 = ["data-variation"];
var _hoisted_2$1 = { "data-amplify-container": "" };
var _hoisted_3$1 = ["data-amplify-router-content"];
var _hoisted_4$1 = {
  key: 1,
            ...
            createBaseVNode("div", {
              ...
              unref(hasTabs) ? (openBlock(), createElementBlock("div", _hoisted_4$1, [
                ((_a2 = unref(actorState)) == null ? void 0 : _a2.matches("signIn")) ? (openBlock(), createBlock(_sfc_main$j, {
                  ...
                  signInSlotI: withCtx(() => [
                    renderSlot(_ctx.$slots, "sign-in")
                  ]),
                  form: withCtx(({ info, onSignInSubmit, onForgotPasswordClicked, onInput }) => [
                    renderSlot(_ctx.$slots, "sign-in-form", {
                      info,
                      onInput,
                      onSignInSubmit,
                      onForgotPasswordClicked
                  ...
                  header: withCtx(() => [
                    renderSlot(_ctx.$slots, "sign-in-header")
                  ]),
                  footer: withCtx(() => [
                    renderSlot(_ctx.$slots, "sign-in-footer")
                  ]),
                  _: 3
                ...
                ((_b = unref(actorState)) == null ? void 0 : _b.matches("signUp")) && !unref(hideSignUp) ? (openBlock(), createBlock(_sfc_main$h, {
                  ...
                  signUpSlotI: withCtx(() => [
                    renderSlot(_ctx.$slots, "sign-up")
                  ]),
                  header: withCtx(() => [
                    renderSlot(_ctx.$slots, "sign-up-header")
                  ]),
                  "signup-fields": withCtx(({ info }) => [
                    renderSlot(_ctx.$slots, "sign-up-fields", { info })
                  ]),
                  footer: withCtx(() => [
                    renderSlot(_ctx.$slots, "sign-up-footer")
                  ]),
                  _: 3
                }, 512)) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              ((_c = unref(actorState)) == null ? void 0 : _c.matches("confirmSignUp")) ? (openBlock(), createBlock(_sfc_main$c, {
                ...
                confirmSignUpSlotI: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-sign-up")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-sign-up-header")
                ]),
                footer: withCtx(({ onConfirmSignUpSubmit, onLostCodeClicked }) => [
                  renderSlot(_ctx.$slots, "confirm-sign-up-footer", {
                    onConfirmSignUpSubmit,
                    onLostCodeClicked
                  })
                ]),
              ...
              ((_d = unref(actorState)) == null ? void 0 : _d.matches("resetPassword")) ? (openBlock(), createBlock(_sfc_main$7, {
                ...
                resetPasswordSlotI: withCtx(() => [
                  renderSlot(_ctx.$slots, "reset-password")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "reset-password-header")
                ]),
                footer: withCtx(({ onResetPasswordSubmit, onBackToSignInClicked }) => [
                  renderSlot(_ctx.$slots, "reset-password-footer", {
                    onResetPasswordSubmit,
                    onBackToSignInClicked
                  })
                ]),
              ...
              ((_e = unref(actorState)) == null ? void 0 : _e.matches("confirmResetPassword")) ? (openBlock(), createBlock(_sfc_main$6, {
                ...
                confirmResetPasswordSlotI: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-reset-password")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-reset-password-header")
                ]),
                footer: withCtx(({ onConfirmResetPasswordSubmit, onLostYourCodeClicked }) => [
                  renderSlot(_ctx.$slots, "confirm-reset-password-footer", {
                    onConfirmResetPasswordSubmit,
                    onLostYourCodeClicked
                  })
                ]),
              ...
              ((_f = unref(actorState)) == null ? void 0 : _f.matches("confirmSignIn")) ? (openBlock(), createBlock(_sfc_main$b, {
                ...
                confirmSignInSlotI: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-sign-in")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-sign-in-header")
                ]),
                footer: withCtx(({ onConfirmSignInSubmit, onBackToSignInClicked }) => [
                  renderSlot(_ctx.$slots, "confirm-sign-in-footer", {
                    onConfirmSignInSubmit,
                    onBackToSignInClicked
                  })
                ]),
              ...
              ((_g = unref(actorState)) == null ? void 0 : _g.matches("setupTOTP.edit")) || ((_h = unref(actorState)) == null ? void 0 : _h.matches("setupTOTP.submit")) ? (openBlock(), createBlock(_sfc_main$a, {
                ...
                confirmSetupTOTPI: withCtx(() => [
                  renderSlot(_ctx.$slots, "setup-totp")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "setup-totp-header")
                ]),
                footer: withCtx(({ onSetupTOTPSubmit, onBackToSignInClicked }) => [
                  renderSlot(_ctx.$slots, "setup-totp-footer", {
                    onSetupTOTPSubmit,
                    onBackToSignInClicked
                  })
                ]),
              ...
              ((_i = unref(actorState)) == null ? void 0 : _i.matches("forceNewPassword")) ? (openBlock(), createBlock(_sfc_main$8, {
                ...
                forceNewPasswordI: withCtx(() => [
                  renderSlot(_ctx.$slots, "force-new-password")
                ]),
                header: withCtx(() => [
              ...
              ((_j = unref(actorState)) == null ? void 0 : _j.matches("verifyUser")) ? (openBlock(), createBlock(_sfc_main$5, {
                ...
                verifyUserSlotI: withCtx(() => [
                  renderSlot(_ctx.$slots, "verify-user")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "verify-user-header")
                ]),
                footer: withCtx(({ onVerifyUserSubmit, onSkipClicked }) => [
                  renderSlot(_ctx.$slots, "verify-user-footer", {
                    onVerifyUserSubmit,
                    onSkipClicked
                  })
                ]),
              ...
              ((_k = unref(actorState)) == null ? void 0 : _k.matches("confirmVerifyUser")) ? (openBlock(), createBlock(_sfc_main$4, {
                ...
                confirmVerifyUserSlotI: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-verify-user")
                ]),
                header: withCtx(() => [
                  renderSlot(_ctx.$slots, "confirm-verify-user-header")
                ]),
                footer: withCtx(({ onConfirmVerifyUserSubmit, onSkipClicked }) => [
                  renderSlot(_ctx.$slots, "confirm-verify-user-footer", {
                    onConfirmVerifyUserSubmit,
                    onSkipClicked
                  })
                ]),
...
var _hoisted_1 = { class: "amplify-flex amplify-field amplify-checkboxfield" };
var _hoisted_2 = { class: "amplify-flex amplify-checkbox" };
var _hoisted_3 = { class: "amplify-visually-hidden" };
var _hoisted_4 = ["data-error", "data-checked"];
var _hoisted_5 = ["data-checked"];
var _hoisted_6 = createBaseVNode("path", { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z" }, null, -1);
var _hoisted_7 = [
  _hoisted_6
];
var _hoisted_8 = createBaseVNode("span", { class: "amplify-text amplify-checkbox__label" }, " I agree with the Terms & Conditions", -1);
var _hoisted_9 = {
  key: 0,
...
var index = {
  install: (app) => {
    ...
    app.component("ConfirmSignUp", _sfc_main$c);
    app.component("ConfirmSignIn", _sfc_main$b);
...
export {
  _sfc_main$x as AmplifyButton,
  _sfc_main as AmplifyCheckBox,
  _sfc_main$1 as AmplifyTextField,
  _sfc_main$3 as Authenticator,
  _sfc_main$9 as AuthenticatorForceNewPasswordFormFields,
  _sfc_main$i as AuthenticatorSignUpFormFields,
  _sfc_main$6 as ConfirmResetPassword,
  _sfc_main$b as ConfirmSignIn,
  _sfc_main$c as ConfirmSignUp,
  _sfc_main$4 as ConfirmVerifyUser,
  _sfc_main$r as FederatedSignIn,
  _sfc_main$8 as ForceNewPassword,
  _sfc_main$o as PasswordControl,
  _sfc_main$2 as RenderInfo,
  _sfc_main$7 as ResetPassword,
  _sfc_main$j as SignIn,
  _sfc_main$h as SignUp,
  _sfc_main$5 as VerifyUser,
  index as default,
  w$1 as translations,
  useAuthenticator
};
